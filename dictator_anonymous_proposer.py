...
with open("ultimatum_prompt/dictator_anonymous_prompt.txt", "r") as f:
...
dir_path = "dictator_game_anonymous_result/non_strategic"
os.makedirs(dir_path, exist_ok=True)

file_path = os.path.join(dir_path, "dictator_anomymous_5.csv")
